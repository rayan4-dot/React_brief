            ...
            {filteredCourses.map(course => (
              ...
              >
                <div className="flex justify-between">
                  <div>
                    <span className="text-xs font-medium text-purple-400 mb-1 bg-purple-900 bg-opacity-30 px-2 py-1 rounded">
                      {course.category_name}
                    </span>
                    <h3 className="font-bold text-lg mt-2">{course.name}</h3>
                    <p className="text-zinc-400 text-sm mt-1">{course.description}</p>
                    
                    <div className="mt-3 flex items-center text-sm text-zinc-500">
                      <span className="mr-4">{course.duration} hours</span>
